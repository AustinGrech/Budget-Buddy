...
-- payoff periode is how long you want to take to pay it off and Date is the initial date of expense made
...
payment_frequency ENUM('monthly', 'weekly', 'bi-weekly') NOT NULL
